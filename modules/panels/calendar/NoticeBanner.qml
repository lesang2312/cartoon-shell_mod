...
// Banner nhỏ hiện lên khi có thông báo báo trước (ví dụ báo trước 10 phút).
Item {
  id: root
  ...
  Rectangle {
    ...
    RowLayout {
      ...
      ColumnLayout {
        ...
        //có thể thay đổi lời nhắc bằng cách xóa từ chữ: 
        //Báo trước " + ReminderService.noticeMinutes + "p"
        CustomText {
          name: root.noticeActive ? ReminderService.activeNotice.text : ""
          size: "small"
          opacity: 0.7
      ...
      Rectangle {
        ...
        MouseArea {
          ...
          onClicked: ReminderService.dismissNotice()
        }
      }
    }
  }
